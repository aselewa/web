...
result <- gen.covmat('BC01/','mutantpos.txt','SRR')
covmat <- result[[1]]
...
```{r}
hist(result[[2]],xlab='Reads',ylab='Frequency',main = 'Distribution of Reads')
```


In addition, **7.7%** of positions are covered at atleast **10X**, and **9.1%** of positions are covered at atleast **5X**, per cell.
