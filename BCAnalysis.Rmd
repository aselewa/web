...
Some cells have ~0 reads that mapped to the alternative alleles. This tells us something about the false negative rate because we know that these mutations do indeed exist. Assuming these mutations have a 100% frequency, the false negative rate is roughy ~2/21 = 0.09. In reality, this number is smaller as these mutations are not 100% frequency.
