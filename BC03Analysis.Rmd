...
freqs <- cbind(avgRef = unname(unlist(covmat[covmat$Gene=='APLP2',pos])), 
               ...
               TPM = 0.1*(unname(unlist(covmat[covmat$Gene=='APLP2',pos-2]))))
barplot(t(freqs),beside=TRUE,legend.text = c("Ref","Alt","TPTM"),
        col = c("red","blue","black"),xlab='Cell',ylab='Counts',main='APLP2')
```
...
freqs <- cbind(avgRef = unname(unlist(covmat[covmat$Gene=='ILK',pos])), 
               ...
               TPM = 0.1*(unname(unlist(covmat[covmat$Gene=='HSPA4',pos-2]))))
barplot(t(freqs),beside=TRUE,legend.text = c("Ref","Alt","TPTM"),
        col = c("red","blue","black"),xlab='Cell',ylab='Counts',main='HSPA4')
```
